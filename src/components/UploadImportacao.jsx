...
export default function UploadImportacao() {
      ...
      <CardContent className="space-y-4">
        ...
        >
          ...
          <p className="text-lg font-medium mb-2">
            Arraste sua planilha de importação aqui
          </p>
        ...
        <div className="space-y-2">
          <Button
            ...
            className="w-full"
          >
            {carregando ? 'Atualizando...' : 'Enviar Dados de Importação'}
          </Button>
        </div>
